...
let randomIndex = randomizer(moviesArray.length);
console.log(moviesArray[randomIndex]);
console.log(moviesArray[randomIndex]['Title']);
console.log(moviesArray[randomIndex]['Poster']);

async function checkStatusFn() {
  let checkStatus;
  checkStatus = await fetch(moviesArray[randomIndex]['Poster']).then(
    data => data['status'],
  );
  return checkStatus;
}

console.log(checkStatusFn());
